...
def load_existing_vector_store():
    ...
    if os.path.exists("./vector_store_db"):
        ...
        return Chroma(persist_directory="./vector_store_db", embedding_function=embeddings)
    return None

def fetch_documents(path: str, query: str, role: str = None):
    try:
        ...
        if not vector_store:
            ...
            vector_store = feed_vector_store_get_index(path)
...
def feed_vector_store_get_index(path: str):
    ...
    vector_store = Chroma.from_documents(
        all_docs, embeddings, persist_directory="./vector_store_db"
    )
...
if __name__ == "__main__":
    output = fetch_documents(path, query, role="engineering")
